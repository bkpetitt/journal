...
router.get('/', function(req, res) {
  ...
  journal.find(function(err, journals) {
    res.render('journals/index', { journals : journals, title: appTitle, subtitle: appSubTitle });
  });
});
...
router.get('/new', function(req, res) {
  ...
  res.render('journals/new', { title: appTitle, subtitle: appSubTitle });
});
...
router.get('/:id/edit', function(req, res) {
  ...
  journal.findById(id, function(err, journal) {
    ...
    res.render('journals/edit', { journal: journal, title: appTitle, subtitle: appSubTitle  });
